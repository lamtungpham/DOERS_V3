...
export default function Navbar() {
  ...
  return (
    <nav className="container mx-auto px-6 py-6 flex justify-between items-center" data-purpose="top-navigation">
      <Link to="/" className="text-3xl font-black tracking-widest text-[#0A0B10]">
        DOERS
      </Link>
      ...
      <Link
        to="/signup"
        className="bg-brand-orange flex items-center gap-2 text-white px-6 py-2.5 rounded-full text-base font-bold hover:bg-orange-600 transition shadow-md"
      >
        Tham gia ngay 
